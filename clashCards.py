    ...
    if response.status_code == 200:
        ...
        for card in data:
            ...
            card_obj = {
                ...
                "hitSpeed": card.get('hitSpeed', None),
                "firstHitSpeed": card.get('firstHitSpeed', None),
                "range": card.get('range', None),
                "targets": card.get('targets', None),
                "unitCount": card.get('unitCount', None),
                "width": card.get('width', 0.0),
